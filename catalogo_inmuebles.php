			...
			<section class="posts col-md-4">
				...
				<strong><?php echo $f['tipo'];?></strong><br>				
					...
					<div class="contenedor-botones">
						<a href="./detalle_inmueble.php?id=<?php  echo $f['idInmuebles'];?>" class="btn btn-primary" data-toggle='popover' data-placement='left' data-trigger='hover' data-content='Ver detalles'>Detalles del producto <span class="glyphicon glyphicon-info-sign"></span></a>
					</div>
					<br>
				</article>
				</div>
