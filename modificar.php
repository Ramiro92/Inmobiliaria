	...
	<!-- <section>
		...
		<?php
				...
				echo "<div class='col-md-11'>";				
						echo "<div class='col-md-2'>Nombre</div>";
						echo "<div class='col-md-2'>Descripcion</div>";
						echo "<div class='col-md-2'>Precio</div>";
						echo "<div class='col-md-2'>Editar</div>";
						echo "<div class='col-md-2'>Eliminar</div>";												
					echo "</div>";
		...
		<?php 
			...
			while($row=mysql_fetch_array($resultado)){
				echo '
				<div class="col-md-11">
					<div class="col-md-2"><input type="text" class="nombre" value="'.$row[8].'"></div>
					...
					<div class="col-md-1"><button class="modificar btn btn-info" data-id="'.$row[0].'">Modificar</button></div>
					<div class="col-md-1"><button class="eliminar btn btn-danger" data-id="'.$row[0].'">Eliminar</button></div>
					<div class="col-md-1"><button class="btn btn-primary btnAlquilar" id="'.$row['idInmuebles'].'">Alquilar</button></div>
					<div class="col-md-1"><button class="btn btn-primary btnDesalquilar" id="'.$row['idInmuebles'].'">Desalquilar</button></div>
				</div>
				';
			}
		?>
